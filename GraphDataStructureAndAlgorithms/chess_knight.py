...
#
# Given any source point and destination point on a chess board, we need to find whether Knight 
# can move to the destination or not.
#
# Knight's movements on a chess board
#
# The above figure details the movements for a knight ( 8 possibilities ). Note that a knight 
