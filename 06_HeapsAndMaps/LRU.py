...
# otherwise return -1.
#
# 2. set(key, value) - Set or insert the value if the key is not already present. When the cache
# reaches its capacity, it should invalidate the least recently used item before inserting 
# the new item.
#
