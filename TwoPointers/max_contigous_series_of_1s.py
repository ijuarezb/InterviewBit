...
class Solution:
    ...
    # maximun number of consecutive 1's

    # @param A : list of integers (1's and 0's)
    # @param M : integer, max number of 0's allowed
    # @return a list of integers
    def maxonesIJB(self, A, M):
        ...
        while wR < len(A):
            ...
            # update widest window if new size is larger
