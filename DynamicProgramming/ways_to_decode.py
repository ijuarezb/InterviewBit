...
if __name__ == "__main__":
    ...
    print(s.numDecodings("10122110"))
    print(s.numDecodings("2871221111122261"))
    print(s.numDecodings("1221112111122221211221221212212212111221222212122221222112122212121212221212122221211112212212211211"))